    ...
    <div className="container mx-auto">
      <div className="relative overflow-hidden rounded-[32px] bg-[#28236B] ">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <a target="_blank" rel="noopener noreferrer"href="https://calendly.com/thefusionapps/30min" className="px-8 py-3 bg-white text-[#28236B] rounded-full font-medium transition-all hover:shadow-lg hover:shadow-white/20 hover:transform hover:-translate-y-1 inline-block">
            Get Started
          </a>
        </div>
