...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Industry - Banking | Secure and efficient banking solutions</title>
        ...
        <meta property="og:title" content="Fusion Apps | Industry - Banking | Secure and efficient banking solutions"/>
      </head>
