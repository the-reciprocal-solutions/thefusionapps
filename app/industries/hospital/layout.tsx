...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Industry - Hospitality | Smarter guest experiences & safety</title>
        ...
        <meta property="og:title" content="Fusion Apps | Industry - Hospitality | Smarter guest experiences & safety"/>
      </head>
