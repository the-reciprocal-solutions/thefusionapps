...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Industry - Retail | AI-driven retail intelligence solutions</title>
        ...
        <meta property="og:title" content="Fusion Apps | Industry - Retail | AI-driven retail intelligence solutions"/>
      </head>
