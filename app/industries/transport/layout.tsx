...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Industry - Transportation | Smarter mobility and monitoring</title>
        ...
        <meta property="og:title" content="Fusion Apps | Industry - Transportation | Smarter mobility and monitoring"/>
      </head>
