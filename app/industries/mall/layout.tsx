...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Industry - Mall Analytics | Enhanced retail space analytics</title>
        ...
        <meta property="og:title" content="Fusion Apps | Industry - Mall Analytics | Enhanced retail space analytics"/>
      </head>
