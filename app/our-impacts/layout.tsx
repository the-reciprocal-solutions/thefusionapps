...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Our Impacts | Real-world success case studies</title>
        ...
        <meta property="og:title" content="Fusion Apps | Our Impacts | Real-world success case studies"/>
      </head>
