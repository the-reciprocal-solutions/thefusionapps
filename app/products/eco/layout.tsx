...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Fusion Eco | Cut electricity costs by 40% - India's smartest energy optimization solution</title>
        ...
        <meta property="og:title" content="Fusion Apps | Fusion Eco | Cut electricity costs by 40% - India's smartest energy optimization solution"/>
      </head>
