...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Fusion Analytics | India's #1 AI-powered visual intelligence platform</title>
        ...
        <meta property="og:title" content="Fusion Apps | Fusion Analytics | India's #1 AI-powered visual intelligence platform"/>
      </head>
