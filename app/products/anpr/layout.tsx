...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Fusion ANPR | India's most reliable vehicle tracking system</title>
        ...
        <meta property="og:title" content="Fusion Apps | Fusion ANPR | India's most reliable vehicle tracking system"/>
      </head>
