...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Fusion Apps | Fusion Attendance | Most advanced facial recognition attendance system in India</title>
        ...
        <meta property="og:title" content="Fusion Apps | Fusion Attendance | Most advanced facial recognition attendance system in India"/>
      </head>
